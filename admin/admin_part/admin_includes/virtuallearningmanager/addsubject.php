<table cellpadding="0" cellspacing="0" width="100%" class="new_articles">
	<form action="admin_includes/virtuallearningmanager/addsubjectsetup.php"
    method="post" name="new_gallery" enctype="multipart/form-data">
    <input type="hidden" name="classid" value="<?php echo $_GET['class']; ?>">
	<tr>
    	<th>Subject</th>
        <td><input type="text" name="subject" id="subject" style="width:70%" required></td>
    </tr>
    <tr>
    	<th>Status</th>
        <td>
    ...
    <tr>
    	<th></th>
        <td>
        	<input type="submit" name="subject_add" value="Add Subject" style="width:130px; float:left; 
