...
<?php
	$id=$_GET['id'];
	$result=$obj->select("select category, gallery_name from tbl_gallery_category where id='$id'");
...
<div class="gallery_manage_one">
    ...
    <input type="submit" name="recover_gallery_image_multiple" 
    value="Restore selected item" onClick="return sure_restore()" 
    ...
    <input type="submit" name="delete_gallery_image_multiple_permanent" 
    value="Delete Permanent" onClick="return delete_image()" 
    style="border:none; background:#900; cursor:pointer; color:#FFF; height:35px; 
    margin:30px 0px; font-weight:bold; font-size:14px; padding:0px 20px;">
    </form>
    <div class="clear"></div>
