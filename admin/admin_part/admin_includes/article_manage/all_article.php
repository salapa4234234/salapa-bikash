<table cellpadding="0" cellspacing="0" width="100%;" class="article_manage">
    ...
    <?php
		...
		$results=$obj->select("select * from tbl_content where del='1' 
    ...
    <tr>
        ...
        <td style="max-width:100px;">
        	<a href="loginsetup.php?topic=articles&task=view&id=<?php echo $data['id']; ?>"  style="float:left;">
            	<img src="them_img/views.png" height="30" title="View">
            </a>
            <a href="loginsetup.php?topic=articles&task=edit&id=<?php echo $data['id']; ?>"  style="float:left;">
