<table cellpadding="0" cellspacing="0" width="100%;" class="article_manage">
    ...
    <tr>
    	<td colspan="10">
        	<input type="submit" name="delete_multiple_permanent" value="Delete parmanent" 
            ...
            <input type="submit" name="recover_multiple" value="Restore Trashed" onclick="return sure_restore()" style="width:130px; margin-right:20px;        	text-align:center; height:23px; float:right; cursor:pointer; background:#069; border:none; color:#FFF; font-weight:bold;">
        </td>
    </tr>
    </form>
</table>