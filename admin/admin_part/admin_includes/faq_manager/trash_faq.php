<table cellpadding="0" cellspacing="0" width="100%;" class="article_manage">
    ...
    <?php
		$result=$obj->select("Select * from tbl_faq where del!='1'");
    ...
    <tr>
    	<td colspan="10">
        	<input type="submit" name="delete_faq_permanent" value="Delete parmanent" 
            ...
            <input type="submit" name="recover_faq_multiple" value="Restore Selected" onclick="return sure_restore()" 
