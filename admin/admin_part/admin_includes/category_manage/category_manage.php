...
<table cellpadding="0" cellspacing="0" width="100%;" class="article_manage">
    ...
    <tr>
        ...
        <td>
			<form action="admin_includes/category_manage/edit_category_setup.php" method="post">
        ...
        <td>
            <a href="loginsetup.php?topic=category&task=edit&id=<?php echo $data['id']; ?>">
            ...
            <form action="admin_includes/category_manage/delete_category_setup.php" method="post" style="display:inline;">
            	<input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                <input type="submit" name="delete_category" onClick="return sure_delete()" value="" title="delete" style="
    ...
    <tr>
    	<td colspan="9">
        	<a href="loginsetup.php?topic=category_add" style="float:left;">
	...
	elseif($task=="edit"){
		include('admin_includes/category_manage/edit_category.php');
	}
	elseif($task=="add"){
