<table cellpadding="0" cellspacing="0" width="100%;" class="article_manage">
    ...
    <?php
		$result=$obj->select("Select * from tbl_menu where del='0' and menu='' and submenu!='' and parent!=''");
    ...
    <tr>
    	<td colspan="10">
        	<input type="submit" name="delete_submenu_permanent" value="Delete parmanent" 
            ...
            <input type="submit" name="recover_submenu_multiple" value="Restore Selected" onclick="return sure_restore()" 
