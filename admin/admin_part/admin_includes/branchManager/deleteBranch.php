<table cellpadding="0" cellspacing="0" width="100%;" class="article_manage">
	...
	<?php
		$result=$obj->select("select * from tbl_branches where del='1' order by id desc");
    ...
    <tr>
    	<td colspan="8">
        	<input type="submit" name="deleteBranchMultiple" value="Delete Selected" onclick="return sure_delete()" style="width:130px;
