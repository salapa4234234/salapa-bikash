   ...
   if(client=="" || client=="null")
   {
	...
	return false;
	   ...
	   alert( "Please choose investor relation file first!" );
		...
		alert( "Change file format first!" );
		document.new_add.image.focus() ;
		document.new_add.image.style.backgroundColor="#FDD";
		return false;
   }
...
function advertise_edit_validate(){
	var client=document.getElementById('client').value;
	var image=document.getElementById('image').value;
   ...
   {
     alert( "Please enter title first!" );
     document.add_edit.client.focus() ;
	 document.add_edit.client.style.backgroundColor="#FDD";
     return false;
   }
   else if( document.add_edit.url.value == "" ){
	alert( "Please enter fiscal year first!" );
	document.add_edit.url.focus() ;
	document.add_edit.url.style.backgroundColor="#FDD";
	return false;
   }
   else if( document.add_edit.type.value == "" ){
	alert( "Please Select Investor Relation Type!" );
	document.add_edit.type.focus() ;
	document.add_edit.type.style.backgroundColor="#FDD";
	return false;
   }
   else if( image !=""){
	   var ex=image.substr(image.lastIndexOf('.')+1).toLowerCase();
	   if(ex!="pdf"){
		alert( "Change file format first!" );
		document.add_edit.image.focus() ;
		document.add_edit.image.style.backgroundColor="#FDD";
		return false;
	   }
   }
   else{
