...
<div class="container">
   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 micro-section">
      <?php
            if(!isset($_GET['id'])){
        ?>
      <div class="news_box">
         ...
         <div class="nav" style="text-align:justify;">
            ...
            <h4>Content Files - </h4>
            <?php echo $data['files']; ?>
            <a href="files/contentFile/<?php echo $data['files']; ?>" target="_blank" style="float:right; background:#900; 
