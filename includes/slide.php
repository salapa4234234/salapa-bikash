<section class="master-slider " id="hero-banner">
    ...
    <div class="ms-slide" style="background: url(), rgba(99, 51, 113, .9)">
        ...
        <a href="<?php echo "main/".base64_encode("introduction"); ?>" class="ms-layer  btn-banner-link"
            data-effect="t(true,n,n,-450,n,n,n,n,n,n,n,n,n,n,n)" data-duration="3000" data-delay="1000"
            data-ease="easeOutQuint" data-type="button" data-origin="ml" data-position="normal" style="color:white;">
            <?php echo $data['alias']; ?> </a>
    </div>
    <?php
		}
	?>
    <div class="flex-container container">
        ...
        <div class="slider-section">
            <div class="slider-main">
                <a href="<?php echo "main/".base64_encode("interestrate"); ?>" style="color:#000">
                    <div class="card">
                        <div class="card-icon">
                ...
                <a href="files/contentFile/calender.pdf" target="_blank" style="color:#000">
                    <div class="card">
                        <div class="card-icon">
                ...
                <a href="https://salapabikasbank-utility.netlify.app/" target="_blank" style="color:#000">
                    <div class="card">
                        <div class="card-icon">
