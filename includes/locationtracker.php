    ...
    <!-- direction ======================================= -->
    <div style="width:100%; line-height:80px; line-height:300px; background:url(images/themImages/locationtrackers.jpg) no-repeat;">
    <?php
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
		...
		?>
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="single-page-header-right">
              <ol class="breadcrumb">
                <li>
                <a href="main/<?php echo base64_encode("download"); ?>">Download</a></li>
		...
		?>
            ...
            <div class="single-page-header-right">
              <ol class="breadcrumb">
                <li>
                <a href="main/<?php echo base64_encode("home"); ?>">Home</a></li>
