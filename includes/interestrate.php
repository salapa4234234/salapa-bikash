    ...
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="margin-top:15px;">
                            <table width="100%" class="download">
                                <tr>
                                    <th colspan="4"
                                        style="text-align:left; padding-left:10px; background:#058100; line-height: 2.2em; font-size:1.5em;">
                                        Interest Rate
                                    </th>
                                </tr>
                                <tr>
        ...
        ?>
                                <tr <?php if($c%2==0){ echo "style='background:#e2ebe2;'";} ?>>
                                    <td><?php echo $c; ?></td>
                                    <td class="downloadtitle" style="max-width:300px;"><?php echo $data['mtitle'];?>
                                    </td>
