...
<footer
    style="background-image:background: background: rgb(31,36,31);
background: linear-gradient(90deg, rgba(31,36,31,1) 0%, rgba(56,55,55,0.969625350140056) 100%, rgba(0,212,255,1) 100%);">
    <div class="container">
                ...
                <div class="footer-logo-column">
                    <a href="#" aria-label="Go to Supabase homepage" title="Go to Supabase Homepage">
                        <img style="border-radius: 9px;"
                            src="https://salapabikasbank.com.np/them_img/edit30dipkar-rai.jpg" loading="lazy"
                            alt="Supabase logo" class="footer-logo" width="200">
                        <address class="text-white">
                            ...
                            <?php echo $companyData['email1']; ?> <br>
                    ...
                    <div class="social-wrapper">
                        <div class='social-links'>
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo $companyData['youtubeVideo']; ?>" target="_blank"
                                        title="Youtube">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="link-columns">
                    <div>
                        <section>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo "main/".base64_encode("mission"); ?>" title="Auth">Mission,
                                        Vision & Values</a>
                                </li>
                                <li>
                        ...
                        <section>
                            ...
                            <ul>
                                <li>
                                    <a href="main/<?php echo base64_encode('branches'); ?>" title="Support">Branches</a>
                                </li>
                                <li>
                                    <a href="main/<?php echo base64_encode('contactus'); ?>" title="Sitemap">Contact
                                        Us</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="main/<?php echo base64_encode('faq'); ?>" title="Help Centre">FAQ</a>
                                </li>
                            </ul>
                        </section>
                    </div>
                    <div>
                        <section>
                            ...
                            <ul>
                                <li>
                                    <a href="main/<?php echo base64_encode('home'); ?>" title="Documentation">Home</a>
                                </li>
                                <li>
                                    <a href="main/<?php echo base64_encode('download'); ?>"
                                ...
                                <li>
                                    <a href="https://gunaso.nrb.org.np/" target="_blank" title="OpenSource">NRB Gunaso
                                        Portal</a>
                                </li>
                            </ul>
                        </section>
                        <section>
                            ...
                            <ul>
                                <li>
                                    <a href="main/<?php echo base64_encode('career'); ?>" title="Terms and services">
                                        Career
                                    </a>
                                </li>
                                <li>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-wrapper">
            ...
            <small>© <span id="year"></span>Salapa Bikas Bank Ltd.</small>
        </div>
    </div>
</footer>