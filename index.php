...
<head>
    ...
    <!-- *************** Font Awesome *************** -->
    <link href="assets/frontend/fonts/font-awesome-5-0-1/css/fontawesome-all.min.css" rel="stylesheet"
        type="text/css" />
  ...
  ?>
   ...
   ?>
    ...
    <?php
		if($topic!="gallery"){
	?>
    <button onclick="topFunction()" class="up-arrow-btn"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"
