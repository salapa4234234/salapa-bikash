 ...
 <div id="vlightbox1">
    ...
    <div>
       ...
       <a class="vlightbox1" href="images/gallery_images/<?php 
						echo $data['image'];?>" title="<?php echo $data['title'];?>">
          <img src="images/gallery_images/<?php echo 
							$data['image'];?>" alt="<?php echo $data['title'];?>" />
       </a>
    </div>
    <?php
						}
    ...
    <div>
       <h2 style="font-size:0.9em; color:#069; 
          ...
          <span class="glyphicon glyphicon-film" style="padding-right:10px;"></span>
          <?php echo $data['title']; ?>
       </h2>
    ...
    <div>
       <p style="font-size:0.9em; line-height:25px; 
          ...
          <span class="glyphicon glyphicon-music" style="padding-right:10px;"></span>
          <?php echo $data['title']; ?>
       </p>
